...
class StatsLineChartShortcode implements \ShortcodeModule\ShortcodeInterface, \ShortcodeModule\ShortcodeEditorUploadInterface
{
    public static function getName(): string
    {
        return 'stats_line_chart';
    }
    ...
    public static function getEditorFields(): array
    {
        return [
            ...
            ComponentEditorContractHelper::styleField(new StatsLineChartComponent()),
        ];
    }
    ...
    public static function handleEditorUpload(string $fieldKey, array $file): array
    {
        ...
        $fileName = ComponentJsonDataLoader::saveUploadedFile(new StatsLineChartComponent(), $file);
    ...
    public function render(array $params, string $channel, array $context = []): string
    {
        ...
        $component = new StatsLineChartComponent();
        $data = ComponentJsonDataLoader::loadFromParams($params, $component);
        if (empty($data)) {
            return '';
        }

        return StatsLineChartComponent::fetchWeb($data, trim((string)($params['style'] ?? '')));
    }
}
